...
public record Goal_GetByIdQuery(Guid userId, Guid Id) : IRequest<Result<GoalDto>>;
public class Goal_GetByIdQueryHandler : IRequestHandler<Goal_GetByIdQuery, Result<GoalDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;
    private readonly IEventLogService _eventLogService;

    public Goal_GetByIdQueryHandler(IMapper mapper, IApplicationDbContext context, IEventLogService eventLogService)
    {
        _context = context;
        _mapper = mapper;
    ...
    public async Task<Result<GoalDto>> Handle(Goal_GetByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        var eventLog = await _eventLogService.Create("GoalFeature", "GoalFeature",
                                                "Goal_GetByIdQuery", request.userId);
