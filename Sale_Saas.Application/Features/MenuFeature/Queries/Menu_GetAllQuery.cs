...
{    public record Menu_GetAllQuery(GetAllQueryRequest RequestData) : IRequest<Result<IEnumerable<MenuDto>>>;
    public class Menu_GetAllQueryHandler : IRequestHandler<Menu_GetAllQuery, Result<IEnumerable<MenuDto>>>
    {
		private readonly IApplicationDbContext _context;
		private readonly IMapper _mapper;

		public Menu_GetAllQueryHandler(IMapper mapper, IApplicationDbContext context)		
		{			
			_context = context;
			_mapper = mapper;
		}
        public async Task<Result<IEnumerable<MenuDto>>> Handle(Menu_GetAllQuery request, CancellationToken cancellationToken)
        {
