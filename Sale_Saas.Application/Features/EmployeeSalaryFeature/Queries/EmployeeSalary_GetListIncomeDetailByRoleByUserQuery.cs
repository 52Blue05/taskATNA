...
public record EmployeeSalary_GetListIncomeDetailByRoleByUserQuery(GetListWithPaginationQueryRequest RequestData, string CurrentTenant) : IRequest<Result<PaginatedList<EmployeeSalaryAllAdminRoleReportDto>>>;

public class EmployeeSalary_GetListIncomeDetailByRoleByUserQueryHandler : IRequestHandler<EmployeeSalary_GetListIncomeDetailByRoleByUserQuery, Result<PaginatedList<EmployeeSalaryAllAdminRoleReportDto>>>
{
    ...
    public EmployeeSalary_GetListIncomeDetailByRoleByUserQueryHandler(IMapper mapper, IApplicationDbContext context, IApplicationRoleService roleService, IEventLogService eventLogService, ITenantApplicationService tenantService, IApplicationUserService applicationUserService)
    {
        _context = context;
        _mapper = mapper;
    ...
    public async Task<Result<PaginatedList<EmployeeSalaryAllAdminRoleReportDto>>> Handle(EmployeeSalary_GetListIncomeDetailByRoleByUserQuery request, CancellationToken cancellationToken)
    {
