...
public record Relationship_AddOrUpdate_WebCommand(Guid UserId, List<AddOrUpdateRequest> RequestData) : IRequest<Result<List<RelationshipDto>>>;

public class Relationship_AddOrUpdate_WebCommandHandler : IRequestHandler<Relationship_AddOrUpdate_WebCommand, Result<List<RelationshipDto>>>
{
    ...
    public Relationship_AddOrUpdate_WebCommandHandler(IMapper mapper,
    ...
    public async Task<Result<List<RelationshipDto>>> Handle(Relationship_AddOrUpdate_WebCommand request, CancellationToken cancellationToken)
    {
