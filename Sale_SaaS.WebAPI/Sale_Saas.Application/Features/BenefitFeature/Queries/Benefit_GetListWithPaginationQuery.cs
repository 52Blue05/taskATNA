...
{
    public record Benefit_GetListWithPaginationQuery(Guid userId, GetListWithPaginationQueryRequest RequestData) : IRequest<Result<PaginatedList<BenefitDto>>>;

    public class Benefit_GetListWithPaginationQueryHandler : IRequestHandler<Benefit_GetListWithPaginationQuery, Result<PaginatedList<BenefitDto>>>
    {
        ...
        public Benefit_GetListWithPaginationQueryHandler(
        ...
        public async Task<Result<PaginatedList<BenefitDto>>> Handle(Benefit_GetListWithPaginationQuery request, CancellationToken cancellationToken)
        {
            ...
            var eventLog = await _eventLogService.Create("BenefitFeature", "BenefitFeature", "Benefit_GetListWithPaginationQuery", request.userId);
