...
public record EmployeeSalary_GetListIncomeInformationWithPaginationQuery(GetListWithPaginationQueryRequest RequestData, string CurrentTenant) : IRequest<Result<PaginatedList<EmployeeSalaryUserReportWithAllTenantDto>>>;

public class EmployeeSalary_GetListIncomeInformationWithPaginationQueryHandler : IRequestHandler<EmployeeSalary_GetListIncomeInformationWithPaginationQuery, Result<PaginatedList<EmployeeSalaryUserReportWithAllTenantDto>>>
{
    ...
    public EmployeeSalary_GetListIncomeInformationWithPaginationQueryHandler(IMapper mapper, IApplicationDbContext context, IApplicationRoleService roleService, IEventLogService eventLogService, ITenantApplicationService tenantService, IApplicationUserService applicationUserService)
    {
        _context = context;
        _mapper = mapper;
    ...
    public async Task<Result<PaginatedList<EmployeeSalaryUserReportWithAllTenantDto>>> Handle(EmployeeSalary_GetListIncomeInformationWithPaginationQuery request, CancellationToken cancellationToken)
    {
