...
{
    public class RelationshipHistoryDto : BaseEntityDto
    {
        public string ApplicationUser { get; set; } = "";
        public RelationshipLevelDto PreviousLevel { get; set; }
        public RelationshipLevelDto UpdatedLevel { get; set; }
        public DateTime CreatedDate { get; set; }
        private class Mapping : Profile
        {
            public Mapping()
            {
                CreateMap<RelationshipHistory, RelationshipHistoryDto>()
