...
using Sale_Saas.Application.Features.ContractStatusFeature.Commands;
...
namespace Sale_Saas.API.Controllers
{
    ...
    public class ContractStatusController : BaseController
    {
        ...
        public ContractStatusController(ILoggerService loggerService)
        {
        ...
        public async Task<IActionResult> GetAll([FromQuery] GetAllQueryRequest request)
        {
            try
            {
                ...
                return Ok(await Mediator.Send(new ContractStatus_GetAllQuery(userId, request)));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetById(Guid id)
        {
            try
            {
                ...
                return Ok(await Mediator.Send(new ContractStatus_GetByIdQuery(userId, id)));
            }
            catch (Exception ex)
            {
                _loggerService.WriteErrorLog(ex, functionName: MethodBase.GetCurrentMethod()?.Name ?? "UnknownMethod");
        ...
        public async Task<IActionResult> AddOrUpdate([FromBody] List<AddOrUpdateRequest> request)
        {
            try
            {
                ...
                return Ok(await Mediator.Send(new ContractStatus_AddOrUpdateCommand(userId, request)));
            }
            catch (Exception ex)
            {
                _loggerService.WriteErrorLog(ex, functionName: MethodBase.GetCurrentMethod()?.Name ?? "UnknownMethod");
        ...
        public async Task<IActionResult> DeleteByIds(string ids, Guid ApplicationUserId)
        {
            try
            {
                ...
                return Ok(await Mediator.Send(new ContractStatus_DeleteByIdCommand(userId, request)));
            }
            catch (Exception ex)
            {
                _loggerService.WriteErrorLog(ex, functionName: MethodBase.GetCurrentMethod()?.Name ?? "UnknownMethod");
